...
- `agents/plot_ecosystem_activity.md` and `scripts/plot_ecosystem_activity.py` for the optional Phase 4 feature-activity plot (file/dir names `ecosystem_*` kept for back-compat with downstream tools).
